...
---
## 게임
### ` 💬 게임 검색 기능 / 🤖 추천 기능 / 🎯 위시리스트 관리 `

> 사용자는 본인이 원하는 게임을 검색하고 위시리스트를 추가할 수 있고 이를 기반으로 게임 추천을 받을 수 있습니다.



<details>
<summary><strong> 💬 게임 검색 기능 </strong></summary><br>

** 게임 검색**
- ** 전체 게임 목록 (Community Feed)**
    - 등록된 전체 게임 목록을 제공받을 수 있습니다
    - **검색 기능**: 쿼리 파라미터(`?genre=`)를 통한 태그 검색 또는 게임 제목 검색 가능
- 게임 상세 정보
    - 게임별 장르나 태그, 출시일이나 플랫폼, 개발사나 배급사 등 다양한 정보를 제공 받을 수 있습니다.

<br></details>

<details>
<summary><strong> 🎯 위시리스트 </strong></summary><br>

** 위시리스트 **
- 사용자는 원하는 게임을 위시리스트에 자유롭게 추가 및 삭제 가능

<br></details>

<details>
<summary><strong> 🤖 추천 기능 </strong></summary><br>

** 위시리스트 기반 추천 기능**
- 위시리스트에 포함된 게임 목록을 기반으로 게임 추천
    - 위시리스트에 포함된 게임 목록에서 태그 추출
    - 추출된 태그 기반으로 전체 게임에서 해당 태그를 가진 게임 검색
    - 검색된 게임 중 선호 태그를 많이 가진 게임 순으로 제공

** 선호 태그 기반 추천 기능**
- 선호 태그 기반 추천 기능
    - 선호 태그 기반으로 전체 게임에서 해당 태그를 가진 게임 검색
    - 검색된 게임 중 선호 태그를 많이 가진 게임 순으로 제공
