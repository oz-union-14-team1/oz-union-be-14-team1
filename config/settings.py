...
VERIFICATION_OK_TTL_SECONDS: int = int(os.getenv("VERIFICATION_OK_TTL_SECONDS", "900"))
PW_RESET_TOKEN_TTL_SECONDS: int = int(os.getenv("PW_RESET_TOKEN_TTL_SECONDS", "900"))
...
RETURN_VERIFICATION_CODE = env.bool("RETURN_VERIFICATION_CODE", default=DEBUG)
